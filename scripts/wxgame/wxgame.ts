    ...
    async onFile(file: plugins.File) {
        if (file.extname == '.js') {
            ...
            if (filename == 'libs/modules/egret/egret.js' || filename == 'libs/modules/egret/egret.min.js') {
                ...
                if (filename == "3rdlib/jszip/jszip.js" || filename == '3rdlib/jszip/jszip.min.js') {
                    content += ";if(!window.JSZip){window.JSZip = module.exports;}"
                }
                if (filename == "3rdlib/particle/particle.js" || filename == '3rdlib/particle/particle.min.js') {
                    content += ";if(!window.particle){window.particle = particle;}"
                }
                file.contents = new Buffer(content);
            }
        }
