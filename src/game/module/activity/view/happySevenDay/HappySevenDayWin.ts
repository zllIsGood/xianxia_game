class HappySevenDayWin extends BaseEuiView {
	...
	private setActivityID():void
	{
		...
		for (let k in data)
		{
			if(data[k].pageStyle == ActivityPageStyle.HAPPYSEVENDAY)
			{
...
ViewManager.ins().reg(HappySevenDayWin, LayerManager.UI_Main);