/*风沙天气*/
class WeatherSand extends WeatherBase {
	 ...
	 * 粒子最大数量
	 */
	protected r_Max: number = 3;//20

	/**
	 * 粒子产生的时间间隔
	 */
	protected r_L_Delay: number = 1000;//15;
	...
	public imageList: Array<string> = ["sand0.png", "sand1.png", "sand2.png"];
	...
	protected getStartY(): number {
		...
		return MathUtils.limitInteger(-map.y - 50, -map.y - 20);
	}

	protected getTargetY(): number {
		let stage = egret.MainContext.instance.stage;
		let map = ViewManager.gamescene.map;
		return -map.y + stage.stageHeight + 200;
	}
